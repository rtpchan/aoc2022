...
# def move(data :List[Number], i) -> List[Number]:
#     n = data[i].n
#     front = data[:i]
...
#     else:
#         mc = i+n
#     front.insert(mc, data[i])
#     return front

# def show(data_list:List[Number]):
#     v = []
...
if __name__ == "__main__":
    ...
    # for i in range(size):
    #     n = data_list.index(data[i])
    #     # data_list = move(data_list, n) # doesn't work
    #     move_link(data[i])
